...
const translations = {
  english: {
    ...
    // Community Siren
    siren_title: "Community Siren",
    siren_subtitle: "Real scam warnings reported by people like you — valid for 24 hours",
    siren_no_reports: "No warnings yet today. Be the first to report a scam!",
    siren_report_btn: "Report a Scam",
    siren_modal_title: "Report a Real-World Scam",
    siren_modal_hint: "Describe the scam you saw — what it said, how it arrived (call, SMS, email, etc.)",
    siren_modal_placeholder: "Example: Got a call pretending to be SBI asking for OTP...",
    siren_modal_submit: "Submit Warning",
    siren_modal_cancel: "Cancel",
    siren_submit_ok: "Your warning has been shared with everyone!",
    siren_submit_err: "Could not submit. Please try again.",
    siren_posted: "Reported",
    siren_ago_min: "min ago",
    siren_ago_hr: "hr ago",
    // Common
    btn_start: "Start",
  ...
  hindi: {
    ...
    // Community Siren
    siren_title: "कम्युनिटी सायरन",
    siren_subtitle: "आप जैसे लोगों द्वारा रिपोर्ट किए गए वास्तविक घोटाले — 24 घंटे के लिए मान्य",
    siren_no_reports: "आज अभी तक कोई चेतावनी नहीं। पहले घोटाला रिपोर्ट करें!",
    siren_report_btn: "घोटाला रिपोर्ट करें",
    siren_modal_title: "एक वास्तविक घोटाला रिपोर्ट करें",
    siren_modal_hint: "वह घोटाला बताएं जो आपने देखा — क्या कहा, कैसे आया (कॉल, SMS, ईमेल आदि)",
    siren_modal_placeholder: "उदाहरण: SBI बनकर OTP मांगने का कॉल आया...",
    siren_modal_submit: "चेतावनी भेजें",
    siren_modal_cancel: "रद्द करें",
    siren_submit_ok: "आपकी चेतावनी सभी के साथ साझा कर दी गई!",
    siren_submit_err: "सबमिट नहीं हो सका। कृपया पुनः प्रयास करें।",
    siren_posted: "रिपोर्ट किया",
    siren_ago_min: "मिनट पहले",
    siren_ago_hr: "घंटे पहले",
    // Common
  ...
  marathi: {
    ...
    // Community Siren
    siren_title: "कम्युनिटी सायरन",
    siren_subtitle: "तुमच्यासारख्या लोकांनी नोंदवलेले खरे फसवणुकीचे इशारे — 24 तासांसाठी वैध",
    siren_no_reports: "आज अद्याप कोणताही इशारा नाही. पहिला घोटाळा नोंदवा!",
    siren_report_btn: "घोटाळा नोंदवा",
    siren_modal_title: "खरा घोटाळा नोंदवा",
    siren_modal_hint: "तुम्ही पाहिलेला घोटाळा सांगा — काय सांगितले, कसे आले (कॉल, SMS, ईमेल इ.)",
    siren_modal_placeholder: "उदाहरण: SBI असल्याचे भासवून OTP मागणारा कॉल आला...",
    siren_modal_submit: "इशारा पाठवा",
    siren_modal_cancel: "रद्द करा",
    siren_submit_ok: "तुमचा इशारा सर्वांशी शेअर केला गेला!",
    siren_submit_err: "सबमिट करता आले नाही. पुन्हा प्रयत्न करा.",
    siren_posted: "नोंदवले",
    siren_ago_min: "मिनिटांपूर्वी",
    siren_ago_hr: "तासांपूर्वी",
    // Common
    btn_start: "सुरू करा",
